...
export default ({navigation, route}) => {
  ...
  return (
    <Layout containerStyle={AppStyle.style.marginLarge}>
      <View
        style={[
      ...
      >
        <View style={[{flex: 1}, AppStyle.style.marginRightLarge]}>
          <Text style={[AppStyle.style.h5, AppStyle.style.marginBottom]}>
            Enable All
          </Text>
          <Text style={[AppStyle.style.p, {color: AppStyle.color.gray}]}>
            Tap to Receive all Notifications
          </Text>
        </View>
        <Switch
          value={enableAll}
          onChangeValue={state => setEnableAll(state)}
        />
      </View>
      <View
        style={[
      ...
      >
        <View style={[{flex: 1}, AppStyle.style.marginRightLarge]}>
          ...
          <Text style={[AppStyle.style.p, {color: AppStyle.color.gray}]}>
            Get Notified when someone follows your Profile, or when you get
            likes & comments.
          </Text>
        </View>
      ...
      >
        <View style={[{flex: 1}, AppStyle.style.marginRightLarge]}>
          ...
          <Text style={[AppStyle.style.p, {color: AppStyle.color.gray}]}>
            Receive Coupons, Promotions & Money Saving Offers
          </Text>
        </View>
      ...
      >
        <View style={[{flex: 1}, AppStyle.style.marginRightLarge]}>
          ...
          <Text style={[AppStyle.style.p, {color: AppStyle.color.gray}]}>
            Receive Updates related to order status, Membership, table booking &
            more
          </Text>
        </View>
