...
export const Style = StyleSheet.create({
    ...
    buttonCountContainer: { alignItems: 'center', justifyContent: 'center', width: 40, height: 40 },
    ...
    selectWidgetContainer: { alignItems: "center", backgroundColor: "white", paddingVertical: width * 0.03, borderRadius: 5, shadowColor: "#c4c4c4", shadowOffset: { width: 1, height: 1 }, shadowOpacity: 0.3, elevation: 1 }
})