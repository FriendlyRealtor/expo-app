...
export const AppTabs = () => {
  return (
    <Tab.Navigator>
			<Tab.Screen name="CMA Tool" component={HomeScreen} options={{ tabBarIcon: () => <Icon name="home" size={30} color="blue" /> }} />
			<Tab.Screen name="Learning" component={ContinueEducationScreen} options={{ tabBarIcon: () => <Icon name="book" size={30} color="blue" /> }} />
