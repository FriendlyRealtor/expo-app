...
export default({onSubmit = () => {}}) => {
    ...
    const submit = async () => {
        let sendSubmit = sendDeliveryAddress(email, username, phone, location, houseNo);
    ...
    return <ScrollView style={[AppStyle.style.groupContainer, AppStyle.style.paddingLarge]}>
        <Text style={[AppStyle.style.p, AppStyle.style.marginBottomLarge]}>ADD NEW ADDRESS</Text>
        <Input 
            label="Your location*"
