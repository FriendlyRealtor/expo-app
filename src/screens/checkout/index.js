...
export default ({ navigation, route }) => {
    ...
    const CardView = () => {
        return <Card onChangePress={() => navigation.navigate(RouteName.Card)} card={card} />;
    }
    return <Layout>
         <ScrollView
                style={{ flex: 1 }}
            ...
            >
                <View style={[AppStyle.style.groupContainer, AppStyle.style.paddingLarge, AppStyle.style.marginBottomLarge, { borderRadius: 0 }]}>
                    <CartMoney moneyTotal={moneyTotal} shippingFee={shippingFee} estimatingTax={estimatingTax} discount={discount} />
                </View>
                <View style={[AppStyle.style.groupContainer, AppStyle.style.paddingLarge, AppStyle.style.marginHorizontalLarge, AppStyle.style.marginBottomLarge]}>
                    <View style={{ flexDirection: "row", ...AppStyle.style.marginBottomLarge }}>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate(RouteName.DeliveryAddress)}>
                ...
                <View style={[AppStyle.style.groupContainer, AppStyle.style.marginHorizontalLarge, AppStyle.style.nonePadding]}>
                    <Text style={[AppStyle.style.p, { fontWeight: "normal" }, AppStyle.style.paddingHorizontalLarge, AppStyle.style.paddingTopLarge]}>PAYMENT METHODS</Text>
                    <RadioCard
                        visible={method == 1}
                        onChange={(status) => {
                        ...
                        title={"Debit Card"}
                        containerStyle={{ borderBottomWidth: 2, borderBottomColor: "#F9F9F9" }}
                ...
                <View style={[AppStyle.style.paddingHorizontalLarge, AppStyle.style.marginVerticalLarge]}>
