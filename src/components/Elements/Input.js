...
export default React.forwardRef(({onPress, multiline = false, editable = true, value, error, errorStyle, label, changeValue = (text) => {}, labelStyle, inputContainerStyle, containerStyle, inputStyle, secureTextEntry, max, keyboardType, placeholder = ""}, ref) => {
    return <View style={[Style.container, containerStyle]}>
        ...
        <View style={[Style.inputContainer, inputContainerStyle]}>
            <TextInput 
                ...
                value={value} onChangeText={changeValue} 
