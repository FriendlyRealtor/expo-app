...
const Form = ['import login info', 'import your info', 'import otp'];
export default ({navigation, route}) => {
  ...
  const footer = () => (
    ...
    >
      ...
      <Pressable onPress={() => navigation.goBack()}>
        <Text style={[AppStyle.style.p, {color: theme.colors.primary}]}>
          LOGIN
        </Text>
      </Pressable>
    </View>
  ...
  return (
    <Layout footer={footer} containerStyle={{paddingHorizontal: 0}}>
      <View style={{flex: 1}}>
        <FlatList
          ...
          <View style={{flex: 1, paddingRight: 8}}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    countStep >= 0 ? theme.colors.primary : 'rgba(0,0,0,0)',
                },
              ]}
            ></View>
          </View>
          <View style={{flex: 1, paddingHorizontal: 4}}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    countStep >= 1 ? theme.colors.primary : 'rgba(0,0,0,0)',
                },
              ]}
            ></View>
          </View>
          <View style={{flex: 1, paddingLeft: 8}}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    countStep >= 2 ? theme.colors.primary : 'rgba(0,0,0,0)',
                },
              ]}
            ></View>
          </View>
