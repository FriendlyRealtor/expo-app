...
import { View, Animated, BackHandler, FlatList, Dimensions, Text, Pressable } from 'react-native';
...
export default ({ navigation, route }) => {
    ...
    const footer = () => <View style={{ flexDirection: 'row', justifyContent: 'center', width: '100%' }}>
    ...
    return <Auth footer={footer} containerStyle={{paddingHorizontal: 0}}>
        <Animated.Text style={[Style.color, { textAlign: 'center', marginTop: 15, marginHorizontal: 15, opacity: formAnimated }]}>
            {countStep == 0 ? "Please Enter your email address and we will send your password by email Immediately." : "Please Enter your New Password"}
        </Animated.Text>
        <FlatList
