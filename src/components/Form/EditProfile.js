  ...
  return (
    <>
      ...
      <View style={[{flexDirection: 'row'}, AppStyle.style.marginBottomLarge]}>
        ...
        >
          <TouchableOpacity
            style={[Style.sexButtonLeft, Style.selectedSexButton(sex, 'Male')]}
            onPress={() => setSex('Male')}
          >
            <Text>Man</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              Style.sexButtonMiddle,
              Style.selectedSexButton(sex, 'Female'),
            ]}
          ...
          <TouchableOpacity
            style={[
              Style.sexButtonRight,
              Style.selectedSexButton(sex, 'Other'),
            ]}
