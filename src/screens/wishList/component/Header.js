...
export default ({}) => {
    ...
    <SafeAreaView style={{ flex: 1 }}>
        <View style={[{ flexDirection: "row", justifyContent: "center" }, AppStyle.style.paddingVertical]}>
            <Text style={[AppStyle.style.h5, { fontWeight: 'normal', color: 'black' }]}>Wishlist</Text>
        </View>
    </SafeAreaView>
</View>
}