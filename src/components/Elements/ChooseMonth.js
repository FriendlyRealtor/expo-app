        ...
        >
          <View style={{flexDirection: 'row', marginBottom: 15}}>
            <View style={[AppStyle.style.padding, {flex: 1}]}>
              <TouchableOpacity
                onPress={() => onPress(listMonth[0])}
                style={[AppStyle.style.contentMiddle, {flex: 1}]}
              >
