  ...
  return (
    <Layout style={{ flex: 1, marginTop: 50 }}>
			<Formik initialValues={{ location: '' }} validationSchema={locationValidationSchema}>
				<Card style={styles.card} header={Header} footer={<Footer getCrmValuation={getCrmValuation} />}>
					<Text>
					A Comparative Market Analysis (CMA) is a crucial tool for real estate agents to accurately price and sell properties. The importance of a good CMA cannot be overstated, as it allows agents to provide their clients with a comprehensive understanding of the local real estate market and make informed decisions about buying or selling a property
					</Text>
					<TextInput
						name="location"
						value={location}
